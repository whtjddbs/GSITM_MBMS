...
public class ReserveHistoryDTO {
	...
	public ReserveHistoryDTO(int reserveNo, int roomNo, String reserveEmpNo, Date startDate, Date endDate,
			...
			String category, int priority, int empCount, char snackYn) {
		super();
